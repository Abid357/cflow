...
public class Stores {
	private final String[] headers = { "Name", "Owner", "Inventory", "Items[]" };
	private final String filePath = _Settings.directory + "\\db\\" + "stores.csv";
	...
	public boolean save(List<Store> list) {
