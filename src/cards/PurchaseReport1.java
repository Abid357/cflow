...
public class PurchaseReport1 extends JPanel implements IReport {
	...
	public PurchaseReport1() {
		...
		pnlTitle.setLayout(new MigLayout("", "[75,fill][10][275]", "[50]"));
	...
	public void generateReport() {
		// TODO Auto-generated method stub
		ReportFacade.generatePurchaseReport1(txtTitle.getText().trim());
	}
}
